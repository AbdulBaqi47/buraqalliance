...
<html lang="en">
	...
	<head>
        ...
        <!--end::Layout Skins -->
        <link rel="shortcut icon" href="<?php echo e(asset('media/logo/Buraq-logo.png')); ?>" />
	</head>
					...
					<div class="kt-login-v2__head">
						<div class="kt-login-v2__logo">
							<a href="#" class="text-dark h5 mb-0">
								<img src="<?php echo e(asset('media/logo/Buraq-logo-inverse.png')); ?>" alt="" class="w-25" />
...
<?php /**PATH C:\Users\DELL 5300\Documents\buraqalliance\resources\views/Central/auth/login.blade.php ENDPATH**/ ?>