    ...
    <div class="kt-header__topbar" style="padding-top: 8px" class="mt-2" >
        <div hidden class="kt-header__topbar-item kt-header__topbar-item--user dropdown kt-header-notification-visa">
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                <form>
                    <div class="kt-head" style="background-image: url(<?php echo e(asset('theme/media/misc/head_bg_sm.jpg')); ?>)">
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                ...
                <div class="kt-header__topbar-user kt-rounded-">
                    ...
                    <span class="kt-badge kt-badge--username kt-badge--lg kt-badge--brand kt-badge--bold"><?php echo e(strtoupper(substr(Auth::user()->name, 0,1))); ?></span>
                </div>
            </div>
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-sm">
                <div class="kt-user-card kt-margin-b-40 kt-margin-b-30-tablet-and-mobile" style="background-image: url(<?php echo e(asset('theme/media/misc/head_bg_sm.jpg')); ?>)">
                    <div class="kt-user-card__wrapper">
                        <div class="kt-user-card__pic">

                            <!--use "kt-rounded" class for rounded avatar style-->
                            <span class="kt-badge kt-badge--username kt-badge--xl kt-badge--danger kt-badge--bold"><?php echo e(strtoupper(substr(Auth::user()->name, 0,1))); ?></span>
                        </div>
                        <div class="kt-user-card__details">
                            <div class="kt-user-card__name"><?php echo e(Auth::user()->name); ?></div>
                            <div class="kt-user-card__position"><?php echo e(Auth::user()->email); ?></div>
                        </div>
                    </div>
                </div>
                <ul class="kt-nav kt-margin-b-10">
                    <li class="kt-nav__item">
                        <a href="<?php echo e(route('central.admin.profile')); ?>" class="kt-nav__link">
                    ...
                    <li class="kt-nav__custom kt-space-between">
                        ...
                        <form id="logout-form" action="<?php echo e(route('central.admin.logout')); ?>" method="POST" style="display: none;">
                            <?php echo csrf_field(); ?>
                        </form>
                    </li>
                </ul>
        ...
        <div class="kr-tasks-container"></div>
...
<?php /**PATH C:\Users\DELL 5300\Documents\buraqalliance\resources\views/Central/layouts/header.blade.php ENDPATH**/ ?>